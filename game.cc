...
//	Date: April 10, 2017
//
//	Description: This is the implementation of the game class from the book
//
//**************************************************************************************
...
namespace main_savitch_14
{
    ...
    {
	string answer;
	display_message("Please enter your move in the form B6,A5\nColumn first, then row.\n"); //Added by Mackenzie
	...
	// Make the best move.
	cout<<"Computers move: "<<best_move<<endl;
	make_move(best_move);
    }
